...
class ReportService:
    ...
    async def _summarize_with_ai(self, texts: List[str], target_name: str) -> str:
        ...
        prompt = (
            ...
            f"ниже, в тегах <review>, даны сырые ответы других роботов. они включают ответы на основные открытые вопросы и комментарии к оценкам по компетенциям. твоя задача — проанализировать их все.\n"
