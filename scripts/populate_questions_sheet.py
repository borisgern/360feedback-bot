...
QUESTIONS_DATA = [
    ...
    {"id": "C-1-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C1_comment"},
    ...
    {"id": "C-2-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C2_comment"},
    ...
    {"id": "C-3-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C3_comment"},
    ...
    {"id": "C-4-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C4_comment"},
    ...
    {"id": "C-5-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C5_comment"},
    ...
    {"id": "C-6-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C6_comment"},
    ...
    {"id": "C-7-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C7_comment"},
    ...
    {"id": "C-8-c", "ui_type": "textarea", "text": "напиши пример по этой оценке или выбери «пропустить»", "options": "", "is_required": "нет", "sheet_column": "C8_comment"},
    # Outcome
